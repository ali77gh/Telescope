...
class MultiLanguageAndThemeSample extends StatefulWidget {
  ...
  @override
  State<MultiLanguageAndThemeSample> createState() =>
      MultiLanguageAndThemeSampleState();
}

class MultiLanguageAndThemeSampleState
    extends State<MultiLanguageAndThemeSample> {
  @override
    ...
    return Material(
        ...
        child: SafeArea(
            child: Container(
                ...
                child: Column(
                  children: [
                    Text(I18n.hello.watch(this),
                        style: TextStyle(color: AppTheme.text.watch(this))),
                    TextButton(
                        onPressed: () {
                          I18n.toggleLanguage();
                        },
